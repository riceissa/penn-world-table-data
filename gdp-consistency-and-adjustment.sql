...
select region, max_consistency, min_consistency, max_consistency - min_consistency as consistency_width, max_adjustment, min_adjustment, max_adjustment - min_adjustment as adjustment_width from mm order by max_adjustment - min_adjustment;
